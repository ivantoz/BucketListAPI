...
from BucketListAPI.model import db, User, BlacklistToken
...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_user_status(self):
        ...
        with self.client:
            ...
            response = self.client.get(
                '/api/v1/auth/status',
                headers={'X-API-TOKEN': json.loads(
    ...
    def test_invalid_logout(self):
        ...
        with self.client:
            ...
            data = json.loads(response.data.decode())
            self.assertTrue(data['message']['status'] == 'fail')
            self.assertTrue(
                data['message']['message'] == 'Signature expired. Please log in again.')
            self.assertEqual(response.status_code, 401)
    ...
    def test_valid_blacklisted_token_logout(self):
        ...
        with self.client:
            ...
            data = json.loads(response.data.decode())
            self.assertTrue(data['message']['status'] == 'fail')
            self.assertTrue(data['message']['message'] == 'Token blacklisted. Please log in again.')
            self.assertEqual(response.status_code, 401)
